...
class MultiBoxLoss(nn.Module):
    def __init__(self, priors, threshold, neg_pos_ratio, variance=[0.1, 0.2], device=torch.device('cpu')):
        super().__init__()
    ...
    def forward(self, predictions, ground_truth):
        ...
        # match priors (defaultt boxes) and ground truth boxes
        ...
        for idx in range(batch_size):
            ...
            match(self.threshold, truths, defaults, self.variance, labels, landms, loc_targets, conf_targets, lnm_targets, idx)
